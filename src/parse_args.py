...
parser.add_argument("-formula", dest="formula", default="Two", help="embedding dimension")

parser.add_argument("-emb_dim", dest="emb_dim", default=180, type=int, help="embedding dimension")
parser.add_argument("-emb_dim2", dest="emb_dim2", default=210, type=int, help="")
parser.add_argument("-emb_dim3", dest="emb_dim3", default=250, type=int, help="")
parser.add_argument("-emb_dim4", dest="emb_dim4", default=270, type=int, help="")
parser.add_argument("-emb_dim5", dest="emb_dim5", default=290, type=int, help="")

parser.add_argument('-gpu', dest='gpu', default=1)
parser.add_argument('-dataset', dest='dataset', default='FACT', help='dataset name')
parser.add_argument('-epoch_num', dest='epoch_num', default=200, help='max epoch num')
parser.add_argument("-new_dim_epoch_num", dest="new_dim_epoch_num", default=1, help="number of gpu")

parser.add_argument("-num_samples_for_retrain", dest="num_samples_for_retrain", default=1000, type=int, help="embedding dimension")

parser.add_argument("-expand_dim", dest="expand_dim", default=False, help="")
parser.add_argument("-use_difficult_samples", dest="use_difficult_samples", default=False, help="")
